...
if(keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(ground)||keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(ground1)||keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(ground2)||keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(ground3)||keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(ground4)||keyDown(UP_ARROW)&&gameState===0&&FireCircle.isTouching(balancerVanisher)){
 ...
 if(keyDown("d")&&gameState===0||keyDown("D")&&gameState===0){
   ...
   FireCircle.collide(balancerVanisher)
   if(keyDown("w")&&gameState===0&&waterCircle.isTouching(ground)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground1)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground2)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground3)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground4)||keyDown("w")&&gameState===0&&waterCircle.isTouching(balancerVanisher)||keyDown("W")&&gameState===0&&waterCircle.isTouching(ground)||keyDown("W")&&gameState===0&&waterCircle.isTouching(ground1)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground2)||keyDown("W")&&gameState===0&&waterCircle.isTouching(ground3)||keyDown("w")&&gameState===0&&waterCircle.isTouching(ground4)||keyDown("W")&&gameState===0&&waterCircle.isTouching(balancerVanisher)){
